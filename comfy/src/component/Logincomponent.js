                ...
                <div className="form-content">
                    <div className="login-form">
                        ...
                        <div className="input-boxes">
                            ...
                            <div className="text1"><a className="text-forget" href="./forgot">Forgot passsword?</a></div>
                            <div className="button input-box">
                                <input type="button" value="Login" />
                            </div>
                            <div className="text2">Don't have an account?<a href="./register"> Signup now</a></div>
                        </div>
                    </div>
                </div>
              </form>    
